...
export default function QuestionsStep({ answers, setValue }: QuestionsStepProps) {
  ...
  if (!isBusiness) {
    return (
      <section className="rounded-2xl border border-neutral-800 bg-black/30 p-5 text-sm text-neutral-300">
