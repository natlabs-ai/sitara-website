...
// Set to true once Twilio + email OTP are configured in production
...
export function AccountStep({
  ...
  return (
    <div className="space-y-5">
        ...
        >
          <input
            ...
            onChange={(e) => {
              ...
              if (mode === 'signup') setValue("emailVerified", false);
            }}
            data-testid="account-email"
          />
          {OTP_ENABLED && mode === 'signup' && (
      ...
      {OTP_ENABLED && emailOtpError && (
        <p className="text-xs text-red-400 -mt-3">{emailOtpError}</p>
      )}
      {OTP_ENABLED && emailOtpSent && !emailOtpError && (
        ...
        <Section>
          ...
          >
            <div className="space-y-3">
              ...
              {/* OTP row — hidden until SMS is configured */}
              {OTP_ENABLED && (
      ...
      {OTP_ENABLED && phoneOtpError && (
        <p className="text-xs text-red-400 -mt-3">{phoneOtpError}</p>
      )}
      {OTP_ENABLED && phoneOtpSent && !phoneOtpError && (
